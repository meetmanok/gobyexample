...
//With all of this in place, we can now implement our custom sort by converting the original fruits slice to byLength,
...
//By following this same pattern of creating a custom type, implementing the three Interface methods on that type,
