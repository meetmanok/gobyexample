...
//We’ve covered the basic of JSON in Go here, but check out the http://blog.golang.org/2011/01/json-and-go.html blog post
//and http://golang.org/pkg/encoding/json/ docs for more.
